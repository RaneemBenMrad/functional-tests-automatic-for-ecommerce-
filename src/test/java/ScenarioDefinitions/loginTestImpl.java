...
public class loginTestImpl {
    ...
    public void user_on_login_page() {
        ...
        driver.get("https://www.yousarssif.com/connexion?back=my-account");
    }

    @When("user enters username and password")
    public void user_enters_username_and_password() {
        driver.findElement(By.id("field-email")).sendKeys("mradranim45@gmail.com");
        driver.findElement(By.id("field-password")).sendKeys("123456*Ranim");
    }
    ...
    public void user_is_navigated_to_home_page() {
        ...
        if (currentUrl.contains("yousarssif")) {
